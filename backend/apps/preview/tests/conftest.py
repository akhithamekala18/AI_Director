# -*- coding: utf-8 -*-
"""Shared fixtures for preview tests (Task 37)."""
import pytest
...
@pytest.fixture
def user(make_user):
    return make_user(username="preview_user", role="Creator")
...
def outsider_client(make_user):
    ...
    outsider = make_user(username="preview_outsider", role="Creator")
