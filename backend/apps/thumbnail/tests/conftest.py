# -*- coding: utf-8 -*-
"""Shared fixtures for thumbnail tests (Task 36)."""
import pytest
...
@pytest.fixture
def user(make_user):
    return make_user(username="thumb_user", role="Creator")
...
def outsider_client(make_user):
    ...
    outsider = make_user(username="thumb_outsider", role="Creator")
